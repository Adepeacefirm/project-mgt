  ...
  return (
    <div className="space-y-6 max-w-6xl mx-auto">
      ...
      <section className="flex flex-wrap gap-4">
        {/* Total Members */}
        <section className="max-sm:w-full dark:bg-gradient-to-br dark:from-zinc-800/70 dark:to-zinc-900/50 border border-gray-300 dark:border-zinc-800 rounded-lg p-6">
      ...
      <div className="w-full">
        {filteredUsers.length === 0 ? (
          ...
          <section className="max-w-4xl w-full">
            {/* Desktop Table */}
            <section className="hidden sm:block overflow-x-auto rounded-md border border-gray-200 dark:border-zinc-800">
